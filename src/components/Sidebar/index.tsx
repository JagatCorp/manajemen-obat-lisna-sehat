        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* {isPasien && pathname !== "/daftar/pasienberobat" && ( */}
              <li>
                <Link
              ...
              {isAdmin &&
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/history/transaksiobatmasuk" ||
                    pathname.includes("history/transaksiobatmasuk")
