        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <button
                ...
                onClick={() => {
                    const modal = document.getElementById("modalTambahSatuan");
            ...
            {/* modal tambah */}
            <TambahSatuan idModal={"modalTambahSatuan"} fetchData={fetchData}/>
            ...
            <div className="max-w-full overflow-x-auto overflow-y-hidden">
              <table className="w-full table-auto">
                ...
                <tbody>
                {satuan && satuan.length > 0 ? (
                    <>
                        {satuan.map((Item, key) => (
                        <tr key={key}>
                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <p className="text-black dark:text-white">
                                    {Item.attributes.nama_satuan}
                                </p>
                            </td>
                            ...
                            <div className="flex items-center space-x-3.5">
                                ...
                                onClick={() => {
                                    const modalEdit = document.getElementById("modalEditSatuan" + key);
                                ...
                                <EditSatuan idModal={"modalEditSatuan" + key} data={Item} fetchData={fetchData}/>

                                <button
                                className="hover:text-primary"
                                onClick={() => {
                                    const modalHapus = document.getElementById('modalHapusSatuan' + key);
                                ...
                                <HapusSatuan idModal={'modalHapusSatuan' + key} data={Item} fetchData={fetchData} />
                    ...
                    <tr>
                        <td colSpan={5} className="text-center">Tidak Ada Data Satuan</td>
                    </tr>
                )}
                </tbody>
              </table>
