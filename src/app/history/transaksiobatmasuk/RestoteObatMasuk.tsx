...
const RestoteObatMasuk = ({ idModal, data, fetchData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                API_URL + "/transaksi_obat_masuk/restore/" + data.id, formData, {
                headers: {
            ...
            if (response.status === 200) {
                ...
                showToastMessage("Data Transaksi Obat Masuk berhasil dikembalikan!");
                setLoading(false);
                fetchData();
            } else {
    ...
    const dataModal = {
        ...
        title: [
            ...
            >
                Restore Data Transaksi Obat Masuk
            </label>,
        ],
        body: [
...
export default RestoteObatMasuk;
