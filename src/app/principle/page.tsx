...
const Principle = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setPrinciple(principle.filter((item) => item.id !== id));
  ...
  const handleEdit = (Item) => {
    setUpdateData({
      id: Item.id,
      nama_instansi: Item.attributes.nama_instansi,
    });
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <button
                ...
                onClick={() => {
                    const modal = document.getElementById("modalTambahPrinciple");
            ...
            {/* modal tambah */}
            <TambahPrinciple idModal={"modalTambahPrinciple"} fetchData={fetchData}/>
            ...
            <div className="max-w-full overflow-x-auto overflow-y-hidden">
              <table className="w-full table-auto">
                ...
                <tbody>
                {principle && principle.length > 0 ? (
                    <>
                        {principle.map((Item, key) => (
                        <tr key={key}>
                            ...
                            <div className="flex items-center space-x-3.5">
                                ...
                                onClick={() => {
                                    const modalEdit = document.getElementById("modalEditPrinciple" + key);
                                ...
                                <EditPrinciple idModal={"modalEditPrinciple" + key} data={Item} fetchData={fetchData}/>

                                <button
                                className="hover:text-primary"
                                onClick={() => {
                                    const modalHapus = document.getElementById('modalHapusPrinciple' + key);
                                ...
                                <HapusPrinciple idModal={'modalHapusPrinciple' + key} data={Item} fetchData={fetchData} />
                    ...
                    <tr>
                        <td colSpan={5} className="text-center">Tidak Ada Data Principle</td>
                    </tr>
                )}
                </tbody>
              </table>
