                        ...
                        <tr key={key}>
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <div className="flex items-center space-x-3.5">
                              ...
                              <EditPrinciple
                                idModal={"modalEditPrinciple" + key}
                                data={Item}
                                fetchData={fetchData}
                              />
                              ...
                              <HapusPrinciple
                                idModal={"modalHapusPrinciple" + key}
                                data={Item}
                                fetchData={fetchData}
                              />
                            </div>
