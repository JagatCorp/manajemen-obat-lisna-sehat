          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
                {urlGambar ? user.nama_dokter : user.nama}
              </h3>
              <p className="font-medium">  {urlGambar ? user.username : user.no_telp}</p>
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {urlGambar ? user.mulai_praktik : user.jk}
                  </span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                ...
                <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {urlGambar ? user.hari_praktik : user.gol_darah}
                  </span>
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  {urlGambar ? user.hari_praktik : user.alamat}
                </p>
              </div>
