...
const Dokter = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            formDataToUpdate.append("spesialis_dokter_id", updateData.spesialis_dokter_id);

            // Cek jika ada file gambar_dokter yang baru atau tidak
            if (updateData.gambar_dokter && updateData.gambar_dokter instanceof File) {
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                {spesialisdokter.map((Itemspesialis) => (
                                                    <option key={Itemspesialis.id} value={Itemspesialis.id}>{Itemspesialis.attributes.nama_spesialis}</option>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setUpdateData({
                                                        ...updateData,
                                                        gambar_dokter: e.target.files ? e.target.files[0] : null, // Memeriksa apakah e.target.files tidak null sebelum mengakses [0]
                                                    })
                                                }
                                            ...
                                            <select
                                                ...
                                                onChange={(e) =>
                                                    setUpdateData({
                                                        ...
                                                        nama_spesialis_dokter: e.target.options[e.target.selectedIndex].text,
                                                    })
                                                }
                                                className="mb-3 mt-2 flex h-10 w-full items-center rounded border border-slate-300 pl-3 text-sm font-normal text-slate-600 focus:border focus:border-indigo-700 focus:outline-none dark:border-slate-100 dark:bg-slate-600 dark:text-white"
                                            >
                                                <option value={updateData.spesialis_dokter_id}>{updateData.nama_spesialis_dokter}</option>{" "}
                                                {spesialisdokter.map((Itemspesialis) => (
                                                    <option key={Itemspesialis.id} value={Itemspesialis.id}>{Itemspesialis.attributes.nama_spesialis}</option>
